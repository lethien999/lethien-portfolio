        ...
        <SectionWrapper id="projects" title="Featured Projects">
            ...
            >
                <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium text-zinc-200 border border-white/15 rounded-full hover:border-[#ff6a3d]/40 hover:text-[#ff6a3d] transition-all duration-300"
                >
